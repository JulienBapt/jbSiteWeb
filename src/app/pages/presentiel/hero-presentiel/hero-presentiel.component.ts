  ...
  template: `
    <section class="hero" aria-label="Coaching présentiel">
      ...
      <div class="hero-right">
        <img src="/assets/images/jb-presentiel-hero.jpg"
          alt="Jean-Baptiste Corona coachant un client en salle de musculation"
          loading="eager" fetchpriority="high" width="800" height="1000" />
      </div>
    </section>
  `,
  styles: [`
    .hero { min-height: 100vh; background: var(--dark); display: grid; grid-template-columns: 1fr 1fr; padding-top: 80px; }
    ...
    @media (max-width: 900px) { .hero { grid-template-columns: 1fr; min-height: auto; } .hero-left { padding: 5rem 1.5rem 3rem; } .hero-right { height: 65vw; } }
  `]
})
